...
abstract class Node {
    ...
    nextNonEmptyDescendants(): Node[] {
        ...
        for (const child of this.children) {
            child.isEmpty()
                ? child.nextNonEmptyDescendants().forEach(descendant => nonEmptyNodes.add(descendant))
...
export default class Map {
    ...
    public readonly yellowFarmers = [this.yellowFarmer1, this.yellowFarmer2, this.yellowFarmer3, this.yellowFarmer4, this.yellowFarmer5, this.yellowFarmer6, this.yellowFarmer7];

    public readonly greenBlueAndOrangeFarmerTiles: Farmer[] = arrayShuffle(
        new Array(12).fill(new GreenFarmer())
    ...
    public readonly workerTiles: Worker[] = arrayShuffle(
        new Array(11).fill(new Herder(false))
    ...
    constructor() {
        ...
        this.foresightSpaces = this.aTiles.splice(0, 2)
